...
from brother_ptouch_driver.transport.usb import UsbTransport, _BULK_OUT_CHUNK
...
@patch("brother_ptouch_driver.transport.usb.usb.util.release_interface")
@patch("brother_ptouch_driver.transport.usb.usb.util.claim_interface")
